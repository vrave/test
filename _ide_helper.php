...
namespace {
	...
	class Paginator extends \Illuminate\Support\Facades\Paginator{
		 ...
		 * @static 
		 */
		 public static function __construct($request, $view, $trans, $pageName = 'pages'){
		...
		/**
		 * Get the number of the current pages.
		 *
		 * @return int
		 * @static 
		 */
		...
		/**
		 * Set the number of the current pages.
		 *
		 * @param int  $number
		 * @return void
		 * @static 
		...
		/**
		 * Set the input pages parameter name used by the paginator.
		 *
		 * @param string  $pageName
		 * @return void
		 * @static 
		...
		/**
		 * Get the input pages parameter name used by the paginator.
		 *
		 * @return string
		 * @static 
		 */
